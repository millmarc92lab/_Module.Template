...
Function Get-MTMPInstallerInfo {
    <#
    .SYNOPSIS
        Get-MTMPInstallerInfo will provide general information about any existing
        _Module.Template modules installed on the current host.
    .INPUTS
        None
    .OUTPUTS
        ...
        │   ├── InstallPath     [string] Path + _Module.Template
    ...
    .EXAMPLE
        PS> Get-MTMPInstallerInfo
        ---
        User   : @{Path=C:\Users\genec\Documents\WindowsPowerShell\Modules\_Module.Template; Installed=True; HighestVer=0.9.9}
        System : @{Path=C:\Program Files\WindowsPowerShell\Modules\_Module.Template; Installed=False; HighestVer=0}
    .LINK
